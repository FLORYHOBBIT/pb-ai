...
本项目拟发布到 [FLORYHOBBIT/pb-ai-mcp](https://github.com/FLORYHOBBIT/pb-ai-mcp)，基于 [npm pb-ai-mcp 1.0.21](https://www.npmjs.com/package/pb-ai-mcp/v/1.0.21) 的发行内容进行修改。不是已确认上游 Git 仓库的 GitHub Fork；原包未提供有效的 repository 地址。
...
本次修改属于 FLORYHOBBIT/pb-ai-mcp：完整 PBT 库列表编译、默认 PBD/PBR/EXE 配置、异常路径回落、中文资源处理和失败恢复，详见 [FIX-README.md](FIX-README.md)。尚未向原 npm 包发布。
