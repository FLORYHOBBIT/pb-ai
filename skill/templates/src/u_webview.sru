...
SubRoutine satwv_navigate(ulong w, string url) LIBRARY "satwebview.dll"
SubRoutine satwv_eval(ulong w, string js) LIBRARY "satwebview.dll"
FUNCTION String satwv_execute_js(ulong w, string js) LIBRARY "satwebview.dll"
FUNCTION String satwv_string(ulong h, long offset) LIBRARY "satwebview.dll" ALIAS FOR "satwv_get_pointer"
SubRoutine satwv_return(ulong w, string id, long status, string result) LIBRARY "satwebview.dll"
SubRoutine satwv_resize(ulong w) LIBRARY "satwebview.dll"
SubRoutine satwv_bind(ulong w, string name, ulong msg, ulong arg) LIBRARY "satwebview.dll"
SubRoutine satwv_unbind(ulong w, string name) LIBRARY "satwebview.dll"
